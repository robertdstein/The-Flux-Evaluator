...
pickle_names = "test_misalignment_decay/dec_"
...
with open(test_configs_file, "w") as f:
    for x in sindecs:
        for i in offsets:
            ...
            Config.set(name, "MaxK", maxk * coenders_k_sens)
...
ax1.set_ylim(ymin=1.e-12, ymax=1.e-8)
...
plt.legend()
plt.tight_layout()
save_path = plot_path + "combined_test_misalignment_decay.pdf"
