...
def read_in_catalogue():
	...
	sources['discoverydate_mjd'] = (np.array([55694.4164699])
		- 0.5 * 368.00423609999416)
	sources['name'] = 'SN_01'
...
def read_in_catalogue_stack(n):
	...
	sources['discoverydate_mjd'] = (55694.4164699 +
		(np.array(range(n)) / float(n)) * 368.00423609999416)
