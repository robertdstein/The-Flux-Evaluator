...
def run():
    """Creates new datasets containing only simulation, or experiental data,
    for decades of energy. This allows tests on the sensitivity contribution
    from different energy bands.
    """

    print ""
    print "Creating new datasets containing specific energy bands"
